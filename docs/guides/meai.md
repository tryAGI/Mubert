...
The Mubert SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package Mubert
```
...
using var client = new MubertClient(
    apiKey: Environment.GetEnvironmentVariable("MUBERT_API_KEY")!);

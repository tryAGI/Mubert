...
namespace Mubert
{
    public partial class PublicClient
    {
        ...
        private static readonly global::Mubert.EndPointSecurityRequirement s_PostPublicStripeWebhookSecurityRequirement0 =
        ...
        private static readonly global::Mubert.EndPointSecurityRequirement[] s_PostPublicStripeWebhookSecurityRequirements =
            new global::Mubert.EndPointSecurityRequirement[]
            {                s_PostPublicStripeWebhookSecurityRequirement0,
            };
        partial void PreparePostPublicStripeWebhookArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PreparePostPublicStripeWebhookRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessPostPublicStripeWebhookResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        {
            await PostPublicStripeWebhookAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mubert.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mubert.AutoSDKHttpResponse> PostPublicStripeWebhookAsResponseAsync(
            global::Mubert.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PreparePostPublicStripeWebhookArguments(
                httpClient: HttpClient);


            var __authorizations = global::Mubert.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_PostPublicStripeWebhookSecurityRequirements,
                operationName: "PostPublicStripeWebhookAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostPublicStripeWebhookRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mubert.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mubert.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostPublicStripeWebhook",
                                methodName: "PostPublicStripeWebhookAsync",
                                pathTemplate: "\"/api/v3/public/stripe/webhook\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostPublicStripeWebhookResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mubert.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Mubert.PostPublicStripeWebhookResponse? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Mubert.PostPublicStripeWebhookResponse.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Mubert.ApiException<global::Mubert.PostPublicStripeWebhookResponse>.Create(

...
namespace Mubert
{
    public partial class PublicClient
    {
        ...
        private static readonly global::Mubert.EndPointSecurityRequirement s_GetPublicPricesSecurityRequirement0 =
        ...
        private static readonly global::Mubert.EndPointSecurityRequirement[] s_GetPublicPricesSecurityRequirements =
            new global::Mubert.EndPointSecurityRequirement[]
            {                s_GetPublicPricesSecurityRequirement0,
            };
        partial void PrepareGetPublicPricesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Mubert.LanguageEnum? lang);
        partial void PrepareGetPublicPricesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Mubert.LanguageEnum? lang);
        partial void ProcessGetPublicPricesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetPublicPricesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mubert.GetPublicPricesResponse> GetPublicPricesAsync(
            global::Mubert.LanguageEnum? lang = default,
            global::Mubert.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetPublicPricesAsResponseAsync(
                lang: lang,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mubert.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mubert.AutoSDKHttpResponse<global::Mubert.GetPublicPricesResponse>> GetPublicPricesAsResponseAsync(
            global::Mubert.LanguageEnum? lang = default,
            global::Mubert.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetPublicPricesArguments(
            ...
            var __authorizations = global::Mubert.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetPublicPricesSecurityRequirements,
                operationName: "GetPublicPricesAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mubert.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mubert.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetPublicPricesAsync",
                                pathTemplate: "\"/api/v3/public/prices\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetPublicPricesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mubert.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetPublicPricesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mubert.GetPublicPricesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mubert.AutoSDKHttpResponse<global::Mubert.GetPublicPricesResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mubert.GetPublicPricesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??

...
{
    /// <inheritdoc />
    public class PlaylistIndexPublicResourceJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Mubert.PlaylistIndexPublicResource>
    {
        /// <inheritdoc />
        public override global::Mubert.PlaylistIndexPublicResource Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::Mubert.PlaylistPublicResource? playlistPublicResource = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            if (playlistPublicResource == null)
            {
                try
                {
                    var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Mubert.PlaylistPublicResource), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Mubert.PlaylistPublicResource> ??
            ...
            var __value = new global::Mubert.PlaylistIndexPublicResource(
        ...
        public override void Write(
            ...
            global::Mubert.PlaylistIndexPublicResource value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsPlaylistPublicResource)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Mubert.PlaylistPublicResource), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Mubert.PlaylistPublicResource?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Mubert.PlaylistPublicResource).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.PlaylistPublicResource!, typeInfo);
            }
        }
    }
}
...
{
    /// <inheritdoc />
    public sealed class StripeSubscriptionStatusEnumNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Mubert.StripeSubscriptionStatusEnum?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::Mubert.StripeSubscriptionStatusEnumExtensions.ToValueString(value.Value));
            }
        }
    }
}

...
namespace Mubert
{
    public partial class PublicServiceClient
    {
        ...
        private static readonly global::Mubert.EndPointSecurityRequirement s_GetServiceLicensesSecurityRequirement0 =
        ...
        private static readonly global::Mubert.EndPointSecurityRequirement[] s_GetServiceLicensesSecurityRequirements =
            new global::Mubert.EndPointSecurityRequirement[]
            {                s_GetServiceLicensesSecurityRequirement0,
            };
        partial void PrepareGetServiceLicensesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? offset,
            ref int? limit);
        partial void PrepareGetServiceLicensesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? offset,
            int? limit);
        partial void ProcessGetServiceLicensesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetServiceLicensesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mubert.GetServiceLicensesResponse> GetServiceLicensesAsync(
            int? offset = default,
            int? limit = default,
            global::Mubert.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetServiceLicensesAsResponseAsync(
                offset: offset,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mubert.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mubert.AutoSDKHttpResponse<global::Mubert.GetServiceLicensesResponse>> GetServiceLicensesAsResponseAsync(
            int? offset = default,
            int? limit = default,
            global::Mubert.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetServiceLicensesArguments(
            ...
            var __authorizations = global::Mubert.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetServiceLicensesSecurityRequirements,
                operationName: "GetServiceLicensesAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetServiceLicensesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mubert.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mubert.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetServiceLicenses",
                                methodName: "GetServiceLicensesAsync",
                                pathTemplate: "\"/api/v3/service/licenses\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetServiceLicensesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mubert.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetServiceLicensesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mubert.GetServiceLicensesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mubert.AutoSDKHttpResponse<global::Mubert.GetServiceLicensesResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mubert.GetServiceLicensesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??

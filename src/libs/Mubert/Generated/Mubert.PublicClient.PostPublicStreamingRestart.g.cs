...
namespace Mubert
{
    public partial class PublicClient
    {
        ...
        private static readonly global::Mubert.EndPointSecurityRequirement s_PostPublicStreamingRestartSecurityRequirement0 =
        ...
        private static readonly global::Mubert.EndPointSecurityRequirement[] s_PostPublicStreamingRestartSecurityRequirements =
            new global::Mubert.EndPointSecurityRequirement[]
            {                s_PostPublicStreamingRestartSecurityRequirement0,
            };
        partial void PreparePostPublicStreamingRestartArguments(
            global::System.Net.Http.HttpClient httpClient,
            object request);
        partial void PreparePostPublicStreamingRestartRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            object request);
        partial void ProcessPostPublicStreamingRestartResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task PostPublicStreamingRestartAsync(

            object request,
            global::Mubert.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await PostPublicStreamingRestartAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mubert.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mubert.AutoSDKHttpResponse> PostPublicStreamingRestartAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostPublicStreamingRestartArguments(
            ...
            var __authorizations = global::Mubert.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostPublicStreamingRestartSecurityRequirements,
                operationName: "PostPublicStreamingRestartAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostPublicStreamingRestartRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mubert.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mubert.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostPublicStreamingRestart",
                                methodName: "PostPublicStreamingRestartAsync",
                                pathTemplate: "\"/api/v3/public/streaming/restart\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostPublicStreamingRestartResponse(
                    httpClient: HttpClient,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await PostPublicStreamingRestartAsync(
                request: __request,
                requestOptions: requestOptions,

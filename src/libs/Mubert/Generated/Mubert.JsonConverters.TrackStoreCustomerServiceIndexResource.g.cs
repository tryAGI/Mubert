...
{
    /// <inheritdoc />
    public class TrackStoreCustomerServiceIndexResourceJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Mubert.TrackStoreCustomerServiceIndexResource>
    {
        /// <inheritdoc />
        public override global::Mubert.TrackStoreCustomerServiceIndexResource Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::Mubert.TrackStoreServiceResource? trackStoreServiceResource = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            if (trackStoreServiceResource == null)
            {
                try
                {
                    var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Mubert.TrackStoreServiceResource), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Mubert.TrackStoreServiceResource> ??
            ...
            var __value = new global::Mubert.TrackStoreCustomerServiceIndexResource(
        ...
        public override void Write(
            ...
            global::Mubert.TrackStoreCustomerServiceIndexResource value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsTrackStoreServiceResource)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Mubert.TrackStoreServiceResource), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Mubert.TrackStoreServiceResource?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Mubert.TrackStoreServiceResource).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.TrackStoreServiceResource!, typeInfo);
            }
        }
    }
}
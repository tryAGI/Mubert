...
namespace Mubert
{
    ...
    public sealed partial class LicenseServiceResource
    {
        ...
        public global::Mubert.LicenseLimitServiceResource? LicenseLimits { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LicenseServiceResource" /> class.
        /// </summary>
        /// <param name="id">
        /// License ID
        /// </param>
        ...
        public LicenseServiceResource(
            ...
            global::Mubert.LicenseLimitServiceResource? licenseLimits)
        {
            this.Id = id;

...
{
    /// <inheritdoc />
    public class TrackGenerationCustomerServiceIndexResourceJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Mubert.TrackGenerationCustomerServiceIndexResource>
    {
        /// <inheritdoc />
        public override global::Mubert.TrackGenerationCustomerServiceIndexResource Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::Mubert.TrackGenerationServiceResource? trackGenerationServiceResource = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            if (trackGenerationServiceResource == null)
            {
                try
                {
                    var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Mubert.TrackGenerationServiceResource), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Mubert.TrackGenerationServiceResource> ??
            ...
            var __value = new global::Mubert.TrackGenerationCustomerServiceIndexResource(
        ...
        public override void Write(
            ...
            global::Mubert.TrackGenerationCustomerServiceIndexResource value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsTrackGenerationServiceResource)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Mubert.TrackGenerationServiceResource), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Mubert.TrackGenerationServiceResource?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Mubert.TrackGenerationServiceResource).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.TrackGenerationServiceResource!, typeInfo);
            }
        }
    }
}
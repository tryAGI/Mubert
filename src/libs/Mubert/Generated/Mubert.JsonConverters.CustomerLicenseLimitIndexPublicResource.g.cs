...
{
    /// <inheritdoc />
    public class CustomerLicenseLimitIndexPublicResourceJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Mubert.CustomerLicenseLimitIndexPublicResource>
    {
        /// <inheritdoc />
        public override global::Mubert.CustomerLicenseLimitIndexPublicResource Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::Mubert.CustomerLicenseLimitPublicResource? customerLicenseLimitPublicResource = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            if (customerLicenseLimitPublicResource == null)
            {
                try
                {
                    var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Mubert.CustomerLicenseLimitPublicResource), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Mubert.CustomerLicenseLimitPublicResource> ??
            ...
            var __value = new global::Mubert.CustomerLicenseLimitIndexPublicResource(
        ...
        public override void Write(
            ...
            global::Mubert.CustomerLicenseLimitIndexPublicResource value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsCustomerLicenseLimitPublicResource)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Mubert.CustomerLicenseLimitPublicResource), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Mubert.CustomerLicenseLimitPublicResource?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Mubert.CustomerLicenseLimitPublicResource).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.CustomerLicenseLimitPublicResource!, typeInfo);
            }
        }
    }
}
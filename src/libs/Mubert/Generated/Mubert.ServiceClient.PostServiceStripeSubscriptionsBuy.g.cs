...
namespace Mubert
{
    public partial class ServiceClient
    {
        ...
        private static readonly global::Mubert.EndPointSecurityRequirement s_PostServiceStripeSubscriptionsBuySecurityRequirement0 =
        ...
        private static readonly global::Mubert.EndPointSecurityRequirement[] s_PostServiceStripeSubscriptionsBuySecurityRequirements =
            new global::Mubert.EndPointSecurityRequirement[]
            {                s_PostServiceStripeSubscriptionsBuySecurityRequirement0,
            };
        partial void PreparePostServiceStripeSubscriptionsBuyArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Mubert.PostServiceStripeSubscriptionsBuyRequest request);
        partial void PreparePostServiceStripeSubscriptionsBuyRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Mubert.PostServiceStripeSubscriptionsBuyRequest request);
        partial void ProcessPostServiceStripeSubscriptionsBuyResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostServiceStripeSubscriptionsBuyResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mubert.PostServiceStripeSubscriptionsBuyResponse> PostServiceStripeSubscriptionsBuyAsync(

            global::Mubert.PostServiceStripeSubscriptionsBuyRequest request,
            global::Mubert.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PostServiceStripeSubscriptionsBuyAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mubert.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mubert.AutoSDKHttpResponse<global::Mubert.PostServiceStripeSubscriptionsBuyResponse>> PostServiceStripeSubscriptionsBuyAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostServiceStripeSubscriptionsBuyArguments(
            ...
            var __authorizations = global::Mubert.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostServiceStripeSubscriptionsBuySecurityRequirements,
                operationName: "PostServiceStripeSubscriptionsBuyAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostServiceStripeSubscriptionsBuyRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mubert.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mubert.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostServiceStripeSubscriptionsBuy",
                                methodName: "PostServiceStripeSubscriptionsBuyAsync",
                                pathTemplate: "\"/api/v3/service/stripe/subscriptions/buy\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostServiceStripeSubscriptionsBuyResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mubert.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 302)
                            {
                                ...
                                throw global::Mubert.ApiException.Create(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                throw global::Mubert.ApiException<global::Mubert.PriceNotFoundException>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostServiceStripeSubscriptionsBuyResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mubert.PostServiceStripeSubscriptionsBuyResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mubert.AutoSDKHttpResponse<global::Mubert.PostServiceStripeSubscriptionsBuyResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mubert.PostServiceStripeSubscriptionsBuyResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Mubert.PostServiceStripeSubscriptionsBuyResponse> PostServiceStripeSubscriptionsBuyAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Mubert.PostServiceStripeSubscriptionsBuyRequest
            {
            ...
            return await PostServiceStripeSubscriptionsBuyAsync(
                request: __request,
                requestOptions: requestOptions,
